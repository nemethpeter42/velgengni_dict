<template>
  <div 
    v-if="modalStore.openModals.has(`WORD_LIST`)"
    class="word-list-modal-container">
    <Teleport to="body">
      <div 
        class="
          fixed inset-0 z-[120]
      ...
      <div 
        ...
        <div 
          ...
          <div 
            ...
            <div 
              class="
                p-2 flex justify-between space-x-2 border-t rounded-b 
                border-gray-200 
...
<script setup lang="ts">
  ...
  import WordListModalContent from '../modal-content/WordListModalContent.vue';
